...
* Double check everything and complete the final project.
* Write report and event write-ups on VSCode.
* Prepare the presentation slides and the product demo.
...
* Final project is running stably, Frontend and Backend are well connected, and final testing is complete.
* Finished writing all weekly worklogs and event write-ups on VSCode using Markdown.
* Prepared the presentation slides, project report, and demo script.
