...
* Write technical blog translations and complete reports on VSCode.
* Debug and fix layout issues on the Frontend of the final project.
...
* Wrote translated blogs on VSCode using Markdown and published them.
* Fixed Frontend layout issues, making user actions smoother.
* Completed the project report framework (system architecture and AWS diagrams).
